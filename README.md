...
### Windows
1. Download latest `wavedrom-editor-v1.4.2-win-{ia32|ia64}.zip` release from here: [releases](https://github.com/wavedrom/wavedrom.github.io/releases)
2. Unzip it into working direactory.
3. run the editor: `WaveDromEditor.exe`

### Linux
1. Download latest `wavedrom-editor-v1.4.2-linux-{ia32|x64}.tar.gz` release from here: [releases](https://github.com/wavedrom/wavedrom.github.io/releases)
