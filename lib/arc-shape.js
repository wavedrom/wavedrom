...
function arcShape (Edge, from, to, accentColor) {
    const color = accentColor || '#0041c4';
    const dx = to.x - from.x;
    const dy = to.y - from.y;
    let lx = ((from.x + to.x) / 2);
    const ly = ((from.y + to.y) / 2);
    let d;
    let style = 'fill:none;stroke:' + color + ';stroke-width:1';
    switch (Edge.shape) {
    case '-'  : {
        break;
    }
    ...
    case '->' : {
        style = ('marker-end:url(#arrowhead);stroke:' + color + ';stroke-width:1;fill:none');
        break;
    }
    case '~>' : {
        style = ('marker-end:url(#arrowhead);stroke:' + color + ';stroke-width:1;fill:none');
    ...
    case '<->' : {
        style = ('marker-end:url(#arrowhead);marker-start:url(#arrowtail);stroke:' + color + ';stroke-width:1;fill:none');
        break;
    }
    case '<~>' : {
        style = ('marker-end:url(#arrowhead);marker-start:url(#arrowtail);stroke:' + color + ';stroke-width:1;fill:none');
    ...
    case '+':   { style = ('marker-end:url(#tee);marker-start:url(#tee);fill:none;stroke:'+ color + ';stroke-width:1'); break; }
