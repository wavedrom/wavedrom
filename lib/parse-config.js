...
function parseConfig (source, lane) {
    ...
    lane.labelsOnOneAndZeroLines=false;
    if(source && source.config && source.config.labelsOnOneAndZeroLines){
        lane.labelsOnOneAndZeroLines = source.config.labelsOnOneAndZeroLines;
    }
